...
!Magnetic field parameter definition
      parameter (L=3)
      parameter (Bm=0.33333333333333333333)
      include'init.h'  
...
c           really seems like this part is not important since here we only calculate he diff between different orbitals, but we do not use it somewhere and just print it
c            
c            do j=1,L
...
!damping of self-consistency                                                                          mixing alpha is fixed here at apha = 0.5
